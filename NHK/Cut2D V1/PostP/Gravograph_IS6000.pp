+================================================
+                                                
+  Gravograph IS6000 plt  -  Vectric machine output configuration file   
+                                                
+================================================
+                                                
+ History                                        
...
+ Who      When       What                         
+ ======== ========== ===========================
+ Tony     09/12/2005 Edited to include pause on material surface   
+ Tony     13/03/2006 Added Job Finish at the end of toolpath                     
+================================================

POST_NAME = "Gravograph IS6000 (plt) (*.plt)"
