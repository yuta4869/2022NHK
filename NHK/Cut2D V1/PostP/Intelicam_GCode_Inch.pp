...
POST_NAME = "Intelicam GCode (Inch) (*.nc)"
...
VAR ARC_CENTRE_I_INC_POSITION = [I|A||1.4]
VAR ARC_CENTRE_J_INC_POSITION = [J|A||1.4]
VAR X_HOME_POSITION = [XH|A||1.4]
VAR Y_HOME_POSITION = [YH|A||1.4]
